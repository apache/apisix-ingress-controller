...
ifeq ($(E2E_SKIP_BUILD), 0)
	...
	docker build -t apache/test-backend:$(IMAGE_TAG) --build-arg ENABLE_PROXY=true ./test/e2e/testbackend
	docker tag apache/test-backend:$(IMAGE_TAG) $(LOCAL_REGISTRY)/apache/test-backend:$(IMAGE_TAG)
