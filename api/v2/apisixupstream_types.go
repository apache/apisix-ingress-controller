...
type ApisixUpstreamSpec struct {
	...
	// ExternalNodes defines a static list of backend nodes. These can be
	// external hosts outside the cluster or cluster-internal Services specified by their DNS name.
