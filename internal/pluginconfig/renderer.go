...
// Render renders a v1alpha1 plugin configuration and merges referenced Secret data.
func Render(plugin v1alpha1.Plugin, namespace string, secrets map[types.NamespacedName]*corev1.Secret) (map[string]any, error) {
