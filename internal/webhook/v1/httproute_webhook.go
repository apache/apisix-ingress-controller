...
func SetupHTTPRouteWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr).
		For(&gatewaynetworkingk8siov1.HTTPRoute{}).
...
func (v *HTTPRouteCustomValidator) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	route, ok := obj.(*gatewaynetworkingk8siov1.HTTPRoute)
	if !ok {
...
func (v *HTTPRouteCustomValidator) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	route, ok := newObj.(*gatewaynetworkingk8siov1.HTTPRoute)
	if !ok {
...
func (v *HTTPRouteCustomValidator) collectWarnings(ctx context.Context, route *gatewaynetworkingk8siov1.HTTPRoute) admission.Warnings {
	...
	processFilters := func(filters []gatewaynetworkingk8siov1.HTTPRouteFilter) {
