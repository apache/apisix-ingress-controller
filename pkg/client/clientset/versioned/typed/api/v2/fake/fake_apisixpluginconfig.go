...
func (c *FakeApisixPluginConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.ApisixPluginConfig, err error) {
	emptyResult := &v2.ApisixPluginConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(apisixpluginconfigsResource, c.ns, name, options), emptyResult)
...
func (c *FakeApisixPluginConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v2.ApisixPluginConfigList, err error) {
	emptyResult := &v2.ApisixPluginConfigList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(apisixpluginconfigsResource, apisixpluginconfigsKind, c.ns, opts), emptyResult)
...
func (c *FakeApisixPluginConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(apisixpluginconfigsResource, c.ns, opts))
...
func (c *FakeApisixPluginConfigs) Create(ctx context.Context, apisixPluginConfig *v2.ApisixPluginConfig, opts v1.CreateOptions) (result *v2.ApisixPluginConfig, err error) {
	emptyResult := &v2.ApisixPluginConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(apisixpluginconfigsResource, c.ns, apisixPluginConfig, opts), emptyResult)
...
func (c *FakeApisixPluginConfigs) Update(ctx context.Context, apisixPluginConfig *v2.ApisixPluginConfig, opts v1.UpdateOptions) (result *v2.ApisixPluginConfig, err error) {
	emptyResult := &v2.ApisixPluginConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(apisixpluginconfigsResource, c.ns, apisixPluginConfig, opts), emptyResult)
...
func (c *FakeApisixPluginConfigs) UpdateStatus(ctx context.Context, apisixPluginConfig *v2.ApisixPluginConfig, opts v1.UpdateOptions) (result *v2.ApisixPluginConfig, err error) {
	emptyResult := &v2.ApisixPluginConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(apisixpluginconfigsResource, "status", c.ns, apisixPluginConfig, opts), emptyResult)
...
func (c *FakeApisixPluginConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(apisixpluginconfigsResource, c.ns, opts, listOpts)
...
func (c *FakeApisixPluginConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.ApisixPluginConfig, err error) {
	emptyResult := &v2.ApisixPluginConfig{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(apisixpluginconfigsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
