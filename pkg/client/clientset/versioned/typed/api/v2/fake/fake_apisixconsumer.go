...
func (c *FakeApisixConsumers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.ApisixConsumer, err error) {
	emptyResult := &v2.ApisixConsumer{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(apisixconsumersResource, c.ns, name, options), emptyResult)
...
func (c *FakeApisixConsumers) List(ctx context.Context, opts v1.ListOptions) (result *v2.ApisixConsumerList, err error) {
	emptyResult := &v2.ApisixConsumerList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(apisixconsumersResource, apisixconsumersKind, c.ns, opts), emptyResult)
...
func (c *FakeApisixConsumers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(apisixconsumersResource, c.ns, opts))
...
func (c *FakeApisixConsumers) Create(ctx context.Context, apisixConsumer *v2.ApisixConsumer, opts v1.CreateOptions) (result *v2.ApisixConsumer, err error) {
	emptyResult := &v2.ApisixConsumer{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(apisixconsumersResource, c.ns, apisixConsumer, opts), emptyResult)
...
func (c *FakeApisixConsumers) Update(ctx context.Context, apisixConsumer *v2.ApisixConsumer, opts v1.UpdateOptions) (result *v2.ApisixConsumer, err error) {
	emptyResult := &v2.ApisixConsumer{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(apisixconsumersResource, c.ns, apisixConsumer, opts), emptyResult)
...
func (c *FakeApisixConsumers) UpdateStatus(ctx context.Context, apisixConsumer *v2.ApisixConsumer, opts v1.UpdateOptions) (result *v2.ApisixConsumer, err error) {
	emptyResult := &v2.ApisixConsumer{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(apisixconsumersResource, "status", c.ns, apisixConsumer, opts), emptyResult)
...
func (c *FakeApisixConsumers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(apisixconsumersResource, c.ns, opts, listOpts)
...
func (c *FakeApisixConsumers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.ApisixConsumer, err error) {
	emptyResult := &v2.ApisixConsumer{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(apisixconsumersResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
