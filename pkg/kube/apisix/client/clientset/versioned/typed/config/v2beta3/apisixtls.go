...
type ApisixTlsInterface interface {
	Create(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.CreateOptions) (*v2beta3.ApisixTls, error)
	Update(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.UpdateOptions) (*v2beta3.ApisixTls, error)
	UpdateStatus(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.UpdateOptions) (*v2beta3.ApisixTls, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2beta3.ApisixTls, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2beta3.ApisixTlsList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta3.ApisixTls, err error)
	ApisixTlsExpansion
}
...
func newApisixTlses(c *ApisixV2beta3Client, namespace string) *apisixTlses {
	return &apisixTlses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apisixTlses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2beta3.ApisixTls, err error) {
...
func (c *apisixTlses) List(ctx context.Context, opts v1.ListOptions) (result *v2beta3.ApisixTlsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2beta3.ApisixTlsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apisixtlses").
...
func (c *apisixTlses) Create(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.CreateOptions) (result *v2beta3.ApisixTls, err error) {
	result = &v2beta3.ApisixTls{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixtlses").
...
func (c *apisixTlses) Update(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.UpdateOptions) (result *v2beta3.ApisixTls, err error) {
	result = &v2beta3.ApisixTls{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixtlses").
...
func (c *apisixTlses) UpdateStatus(ctx context.Context, apisixTls *v2beta3.ApisixTls, opts v1.UpdateOptions) (result *v2beta3.ApisixTls, err error) {
	result = &v2beta3.ApisixTls{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixtlses").
...
func (c *apisixTlses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta3.ApisixTls, err error) {
	result = &v2beta3.ApisixTls{}
