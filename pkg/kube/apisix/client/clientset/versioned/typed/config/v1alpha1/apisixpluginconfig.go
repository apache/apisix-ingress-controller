...
type ApisixPluginConfigInterface interface {
	Create(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.CreateOptions) (*v1alpha1.ApisixPluginConfig, error)
	Update(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.UpdateOptions) (*v1alpha1.ApisixPluginConfig, error)
	UpdateStatus(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.UpdateOptions) (*v1alpha1.ApisixPluginConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ApisixPluginConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ApisixPluginConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApisixPluginConfig, err error)
...
func newApisixPluginConfigs(c *ApisixV1alpha1Client, namespace string) *apisixPluginConfigs {
...
func (c *apisixPluginConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApisixPluginConfig, err error) {
	result = &v1alpha1.ApisixPluginConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apisixPluginConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApisixPluginConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApisixPluginConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Create(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.CreateOptions) (result *v1alpha1.ApisixPluginConfig, err error) {
	result = &v1alpha1.ApisixPluginConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Update(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.UpdateOptions) (result *v1alpha1.ApisixPluginConfig, err error) {
	result = &v1alpha1.ApisixPluginConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) UpdateStatus(ctx context.Context, apisixPluginConfig *v1alpha1.ApisixPluginConfig, opts v1.UpdateOptions) (result *v1alpha1.ApisixPluginConfig, err error) {
	result = &v1alpha1.ApisixPluginConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApisixPluginConfig, err error) {
	result = &v1alpha1.ApisixPluginConfig{}
