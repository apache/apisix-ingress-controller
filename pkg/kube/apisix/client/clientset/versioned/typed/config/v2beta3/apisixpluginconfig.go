...
type ApisixPluginConfigInterface interface {
	Create(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.CreateOptions) (*v2beta3.ApisixPluginConfig, error)
	Update(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.UpdateOptions) (*v2beta3.ApisixPluginConfig, error)
	UpdateStatus(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.UpdateOptions) (*v2beta3.ApisixPluginConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2beta3.ApisixPluginConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2beta3.ApisixPluginConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta3.ApisixPluginConfig, err error)
...
func newApisixPluginConfigs(c *ApisixV2beta3Client, namespace string) *apisixPluginConfigs {
...
func (c *apisixPluginConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2beta3.ApisixPluginConfig, err error) {
	result = &v2beta3.ApisixPluginConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apisixPluginConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v2beta3.ApisixPluginConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2beta3.ApisixPluginConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Create(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.CreateOptions) (result *v2beta3.ApisixPluginConfig, err error) {
	result = &v2beta3.ApisixPluginConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Update(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.UpdateOptions) (result *v2beta3.ApisixPluginConfig, err error) {
	result = &v2beta3.ApisixPluginConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) UpdateStatus(ctx context.Context, apisixPluginConfig *v2beta3.ApisixPluginConfig, opts v1.UpdateOptions) (result *v2beta3.ApisixPluginConfig, err error) {
	result = &v2beta3.ApisixPluginConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixpluginconfigs").
...
func (c *apisixPluginConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta3.ApisixPluginConfig, err error) {
	result = &v2beta3.ApisixPluginConfig{}
