...
type ApisixUpstreamInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*v1.ApisixUpstreamList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ApisixUpstream, err error)
...
func (c *apisixUpstreams) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ApisixUpstream, err error) {
...
func (c *apisixUpstreams) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ApisixUpstreamList, err error) {
...
func (c *apisixUpstreams) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apisixUpstreams) Create(ctx context.Context, apisixUpstream *v1.ApisixUpstream, opts metav1.CreateOptions) (result *v1.ApisixUpstream, err error) {
	result = &v1.ApisixUpstream{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixupstreams").
...
func (c *apisixUpstreams) Update(ctx context.Context, apisixUpstream *v1.ApisixUpstream, opts metav1.UpdateOptions) (result *v1.ApisixUpstream, err error) {
	result = &v1.ApisixUpstream{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixupstreams").
...
func (c *apisixUpstreams) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *apisixUpstreams) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *apisixUpstreams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ApisixUpstream, err error) {
	result = &v1.ApisixUpstream{}
