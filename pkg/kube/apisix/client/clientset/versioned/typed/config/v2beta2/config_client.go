...
// ApisixV2beta2Client is used to interact with features provided by the apisix.apache.org group.
...
// NewForConfigAndClient creates a new ApisixV2beta2Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ApisixV2beta2Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
