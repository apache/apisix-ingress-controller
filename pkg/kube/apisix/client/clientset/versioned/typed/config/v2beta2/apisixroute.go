...
type ApisixRouteInterface interface {
	Create(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.CreateOptions) (*v2beta2.ApisixRoute, error)
	Update(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.UpdateOptions) (*v2beta2.ApisixRoute, error)
	UpdateStatus(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.UpdateOptions) (*v2beta2.ApisixRoute, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2beta2.ApisixRoute, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2beta2.ApisixRouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta2.ApisixRoute, err error)
...
func (c *apisixRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2beta2.ApisixRoute, err error) {
...
func (c *apisixRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v2beta2.ApisixRouteList, err error) {
...
func (c *apisixRoutes) Create(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.CreateOptions) (result *v2beta2.ApisixRoute, err error) {
	result = &v2beta2.ApisixRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixroutes").
...
func (c *apisixRoutes) Update(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.UpdateOptions) (result *v2beta2.ApisixRoute, err error) {
	result = &v2beta2.ApisixRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixroutes").
...
func (c *apisixRoutes) UpdateStatus(ctx context.Context, apisixRoute *v2beta2.ApisixRoute, opts v1.UpdateOptions) (result *v2beta2.ApisixRoute, err error) {
	result = &v2beta2.ApisixRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixroutes").
...
func (c *apisixRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2beta2.ApisixRoute, err error) {
	result = &v2beta2.ApisixRoute{}
