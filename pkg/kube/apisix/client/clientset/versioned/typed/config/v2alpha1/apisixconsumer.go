...
func newApisixConsumers(c *ApisixV2alpha1Client, namespace string) *apisixConsumers {
...
func (c *apisixConsumers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.ApisixConsumer, err error) {
...
func (c *apisixConsumers) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.ApisixConsumerList, err error) {
...
func (c *apisixConsumers) Create(ctx context.Context, apisixConsumer *v2alpha1.ApisixConsumer, opts v1.CreateOptions) (result *v2alpha1.ApisixConsumer, err error) {
	result = &v2alpha1.ApisixConsumer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apisixconsumers").
...
func (c *apisixConsumers) Update(ctx context.Context, apisixConsumer *v2alpha1.ApisixConsumer, opts v1.UpdateOptions) (result *v2alpha1.ApisixConsumer, err error) {
	result = &v2alpha1.ApisixConsumer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixconsumers").
...
func (c *apisixConsumers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.ApisixConsumer, err error) {
	result = &v2alpha1.ApisixConsumer{}
