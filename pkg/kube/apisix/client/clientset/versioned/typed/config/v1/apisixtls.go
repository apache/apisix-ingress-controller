...
type ApisixTlsInterface interface {
	...
	UpdateStatus(ctx context.Context, apisixTls *v1.ApisixTls, opts metav1.UpdateOptions) (*v1.ApisixTls, error)
...
func (c *apisixTlses) UpdateStatus(ctx context.Context, apisixTls *v1.ApisixTls, opts metav1.UpdateOptions) (result *v1.ApisixTls, err error) {
	result = &v1.ApisixTls{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apisixtlses").
