...
import (
	...
	configv1alpha1 "github.com/apache/apisix-ingress-controller/pkg/kube/apisix/apis/config/v1alpha1"
	...
	v1alpha1 "github.com/apache/apisix-ingress-controller/pkg/kube/apisix/client/listers/config/v1alpha1"
...
type ApisixPluginConfigInformer interface {
	...
	Lister() v1alpha1.ApisixPluginConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV1alpha1().ApisixPluginConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV1alpha1().ApisixPluginConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&configv1alpha1.ApisixPluginConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apisixPluginConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1alpha1.ApisixPluginConfig{}, f.defaultInformer)
}

func (f *apisixPluginConfigInformer) Lister() v1alpha1.ApisixPluginConfigLister {
	return v1alpha1.NewApisixPluginConfigLister(f.Informer().GetIndexer())
}
