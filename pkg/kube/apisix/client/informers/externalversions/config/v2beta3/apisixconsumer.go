...
type ApisixConsumerInformer interface {
	...
	Lister() v2beta3.ApisixConsumerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV2beta3().ApisixConsumers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV2beta3().ApisixConsumers(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *apisixConsumerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv2beta3.ApisixConsumer{}, f.defaultInformer)
}

func (f *apisixConsumerInformer) Lister() v2beta3.ApisixConsumerLister {
	return v2beta3.NewApisixConsumerLister(f.Informer().GetIndexer())
}
