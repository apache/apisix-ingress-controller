...
type ApisixUpstreamInformer interface {
	...
	Lister() v2beta3.ApisixUpstreamLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV2beta3().ApisixUpstreams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV2beta3().ApisixUpstreams(namespace).Watch(context.TODO(), options)
			},
		},
		&configv2beta3.ApisixUpstream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apisixUpstreamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv2beta3.ApisixUpstream{}, f.defaultInformer)
}

func (f *apisixUpstreamInformer) Lister() v2beta3.ApisixUpstreamLister {
	return v2beta3.NewApisixUpstreamLister(f.Informer().GetIndexer())
}
