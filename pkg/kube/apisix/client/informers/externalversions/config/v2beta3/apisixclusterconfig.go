...
type ApisixClusterConfigInformer interface {
	...
	Lister() v2beta3.ApisixClusterConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV2beta3().ApisixClusterConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV2beta3().ApisixClusterConfigs().Watch(context.TODO(), options)
			},
		},
		&configv2beta3.ApisixClusterConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apisixClusterConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv2beta3.ApisixClusterConfig{}, f.defaultInformer)
}

func (f *apisixClusterConfigInformer) Lister() v2beta3.ApisixClusterConfigLister {
	return v2beta3.NewApisixClusterConfigLister(f.Informer().GetIndexer())
}
