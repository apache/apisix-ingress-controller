...
type ApisixTlsInformer interface {
	...
	Lister() v2beta3.ApisixTlsLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV2beta3().ApisixTlses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV2beta3().ApisixTlses(namespace).Watch(context.TODO(), options)
			},
		},
		&configv2beta3.ApisixTls{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apisixTlsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv2beta3.ApisixTls{}, f.defaultInformer)
}

func (f *apisixTlsInformer) Lister() v2beta3.ApisixTlsLister {
	return v2beta3.NewApisixTlsLister(f.Informer().GetIndexer())
}
