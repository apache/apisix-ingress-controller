...
type ApisixPluginConfigInformer interface {
	...
	Lister() v2beta1.ApisixPluginConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisixV2beta1().ApisixPluginConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisixV2beta1().ApisixPluginConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&configv2beta1.ApisixPluginConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apisixPluginConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv2beta1.ApisixPluginConfig{}, f.defaultInformer)
}

func (f *apisixPluginConfigInformer) Lister() v2beta1.ApisixPluginConfigLister {
	return v2beta1.NewApisixPluginConfigLister(f.Informer().GetIndexer())
}
