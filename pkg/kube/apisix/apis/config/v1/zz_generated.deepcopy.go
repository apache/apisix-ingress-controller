...
func (in *ApisixUpstreamConfig) DeepCopyInto(out *ApisixUpstreamConfig) {
	*out = *in
	...
	if in.HttpHostRewritePolicy != nil {
		in, out := &in.HttpHostRewritePolicy, &out.HttpHostRewritePolicy
		*out = new(HttpHostRewritePolicy)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HttpHostRewritePolicy) DeepCopyInto(out *HttpHostRewritePolicy) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HttpHostRewritePolicy.
func (in *HttpHostRewritePolicy) DeepCopy() *HttpHostRewritePolicy {
	if in == nil {
		return nil
	}
	out := new(HttpHostRewritePolicy)
