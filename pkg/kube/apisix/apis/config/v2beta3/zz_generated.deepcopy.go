...
func (in *ApisixConsumerAuthParameter) DeepCopyInto(out *ApisixConsumerAuthParameter) {
	*out = *in
	...
	if in.OpenIDConnect != nil {
		...
		*out = new(ApisixConsumerOpenIDConnect)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApisixConsumerOpenIDConnect) DeepCopyInto(out *ApisixConsumerOpenIDConnect) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(v1.LocalObjectReference)
	...
	if in.Value != nil {
		in, out := &in.Value, &out.Value
		*out = new(ApisixConsumerOpenIDConnectValue)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApisixConsumerOpenIDConnect.
func (in *ApisixConsumerOpenIDConnect) DeepCopy() *ApisixConsumerOpenIDConnect {
	if in == nil {
		return nil
	}
	out := new(ApisixConsumerOpenIDConnect)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApisixConsumerOpenIDConnectSession) DeepCopyInto(out *ApisixConsumerOpenIDConnectSession) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApisixConsumerOpenIDConnectSession.
func (in *ApisixConsumerOpenIDConnectSession) DeepCopy() *ApisixConsumerOpenIDConnectSession {
	if in == nil {
		return nil
	}
	out := new(ApisixConsumerOpenIDConnectSession)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApisixConsumerOpenIDConnectValue) DeepCopyInto(out *ApisixConsumerOpenIDConnectValue) {
	*out = *in
	if in.Session != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApisixConsumerOpenIDConnectValue.
func (in *ApisixConsumerOpenIDConnectValue) DeepCopy() *ApisixConsumerOpenIDConnectValue {
	if in == nil {
		return nil
	}
	out := new(ApisixConsumerOpenIDConnectValue)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostType) DeepCopyInto(out *HostType) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostType.
func (in *HostType) DeepCopy() *HostType {
	if in == nil {
		return nil
	}
	out := new(HostType)
