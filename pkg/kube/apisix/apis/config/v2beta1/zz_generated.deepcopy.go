...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ApisixPluginConfigLabels) DeepCopyInto(out *ApisixPluginConfigLabels) {
	{
		in := &in
		*out = make(ApisixPluginConfigLabels, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApisixPluginConfigLabels.
func (in ApisixPluginConfigLabels) DeepCopy() ApisixPluginConfigLabels {
	if in == nil {
		return nil
	}
	out := new(ApisixPluginConfigLabels)
	in.DeepCopyInto(out)
	return *out
}
