...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WolfRbacRouteConfig) DeepCopyInto(out *WolfRbacRouteConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WolfRbacRouteConfig.
func (in *WolfRbacRouteConfig) DeepCopy() *WolfRbacRouteConfig {
	if in == nil {
		return nil
	}
	out := new(WolfRbacRouteConfig)
	in.DeepCopyInto(out)
	return out
}
