---
title: 在 Minikube 上安装 Ingress APISIX 
---
...
本文档介绍如何在 [Minikube](https://minikube.sigs.k8s.io/) 上安装 Ingress APISIX。
...
值得注意的是 `allow.ipList` 字段应根据 Minikube 的 Pod CIRD 配置进行定制，以便 apisix-ingress-controller 实例可以访问 APISIX 实例（ 资源推送 ）。
