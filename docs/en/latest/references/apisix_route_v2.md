...
| http[].upstreams                     | array              | Upstreams refer to ApisixUpstream CRD.                                                                                                                                                    |
| http[].upstreams[].name              | string             | Upstream name refer to ApisixUpstream CRD.                                                                                                                                                |
| http[].upstreams[].weight            | integer            | The proportion of selections for each upstream.                                                                                                                                           |
