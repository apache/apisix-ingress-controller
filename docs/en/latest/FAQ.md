...
Usually, you need to modify the Admin API key to protect Apache APISIX. Please refer to this [link](https://apisix.apache.org/docs/apisix/2.14/how-to-build/#updating-admin-api-key) to simply change Apache APISIX.
